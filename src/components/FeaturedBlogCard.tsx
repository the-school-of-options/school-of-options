...
export default function FeaturedBlogCard({ blog, priority }: FeaturedBlogCardProps) {
  return (
    <Link href={`/knowledge-hub/blogs/${blog.slug}`} className="block">
      <article className="bg-white rounded-xl sm:rounded-2xl overflow-hidden shadow-lg hover:shadow-xl transition-shadow group relative cursor-pointer">
        {/* Featured Badge */}
        ...
        <div className="p-4 sm:p-6 lg:p-8">
          ...
          <div className="flex items-center justify-between">
            ...
            <div className="text-accent font-bold flex items-center gap-2 text-sm sm:text-base group-hover:translate-x-1 transition-transform">
              Read Article
