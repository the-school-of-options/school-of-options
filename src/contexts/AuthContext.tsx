  ...
  useEffect(() => {
    const initAuth = async () => {
      ...
      try {
        ...
        if (accessToken && userData) {
          try {
            ...
            if (refreshToken) {
              ...
              console.log(
                "✅ AuthContext: Setting user from stored data (with refresh token)"
              );
              setUser(parsedUser);
            } else {
              ...
              console.log(
                "✅ AuthContext: Setting user from stored data (no refresh token)"
              );
              setUser(parsedUser);
            }
          } catch (parseError) {
        ...
        console.log(
          "🔍 AuthContext: Initialization complete, setting isLoading to false"
        );
        setIsLoading(false);
      }
    };
